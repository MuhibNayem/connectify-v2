...
func (c *Client) CreateEvent(ctx context.Context, userID primitive.ObjectID, req models.CreateEventRequest) (*models.Event, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.CreateEvent(ctx, &eventspb.CreateEventRequest{
			UserId: userID.Hex(),
...
func (c *Client) GetEvent(ctx context.Context, id primitive.ObjectID, viewerID primitive.ObjectID) (*models.EventResponse, error) {
	...
	event := toModelEventResponse(result.(*eventspb.EventResponse).GetEvent())
	return &event, nil
}
...
func (c *Client) UpdateEvent(ctx context.Context, id, userID primitive.ObjectID, req models.UpdateEventRequest) (*models.EventResponse, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.UpdateEvent(ctx, &eventspb.UpdateEventRequest{
			UserId:  userID.Hex(),
			EventId: id.Hex(),
...
func (c *Client) DeleteEvent(ctx context.Context, id, userID primitive.ObjectID) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.DeleteEvent(ctx, &eventspb.DeleteEventRequest{
			UserId:  userID.Hex(),
			EventId: id.Hex(),
		})
	})
...
func (c *Client) ListEvents(ctx context.Context, userID primitive.ObjectID, limit, page int64, query, category, period string) ([]models.EventResponse, int64, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.ListEvents(ctx, &eventspb.ListEventsRequest{
	...
	resp := result.(*eventspb.ListEventsResponse)
...
func (c *Client) GetUserEvents(ctx context.Context, userID primitive.ObjectID, limit, page int64) ([]models.EventResponse, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetMyEvents(ctx, &eventspb.GetMyEventsRequest{
			UserId: userID.Hex(),
			Limit:  limit,
			Page:   page,
		})
	...
	return toModelEventResponses(result.(*eventspb.ListEventsResponse).GetEvents()), nil
}

func (c *Client) GetFriendBirthdays(ctx context.Context, userID primitive.ObjectID) (*models.BirthdayResponse, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetBirthdays(ctx, &eventspb.GetBirthdaysRequest{
			UserId: userID.Hex(),
		})
	})
	if err != nil {
	...
	return toModelBirthdays(result.(*eventspb.BirthdaysResponse)), nil
}
...
func (c *Client) RSVP(ctx context.Context, eventID primitive.ObjectID, userID primitive.ObjectID, status models.RSVPStatus) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.RSVP(ctx, &eventspb.RSVPRequest{
			UserId:  userID.Hex(),
			EventId: eventID.Hex(),
...
func (c *Client) InviteFriends(ctx context.Context, eventID, inviterID primitive.ObjectID, friendIDs []string, message string) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.InviteFriends(ctx, &eventspb.InviteFriendsRequest{
...
func (c *Client) GetUserInvitations(ctx context.Context, userID primitive.ObjectID, limit, page int64) ([]models.EventInvitationResponse, int64, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetInvitations(ctx, &eventspb.GetInvitationsRequest{
			UserId: userID.Hex(),
			Limit:  limit,
			Page:   page,
		})
	...
	resp := result.(*eventspb.GetInvitationsResponse)
...
func (c *Client) RespondToInvitation(ctx context.Context, invitationID, userID primitive.ObjectID, accept bool) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.RespondToInvitation(ctx, &eventspb.RespondToInvitationRequest{
			UserId:       userID.Hex(),
...
func (c *Client) CreatePost(ctx context.Context, eventID, authorID primitive.ObjectID, req models.CreateEventPostRequest) (*models.EventPostResponse, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.CreatePost(ctx, &eventspb.CreatePostRequest{
			UserId:    authorID.Hex(),
			EventId:   eventID.Hex(),
			Content:   req.Content,
	...
	post := toModelPost(result.(*eventspb.EventPost))
	return &post, nil
}
...
func (c *Client) GetPosts(ctx context.Context, eventID primitive.ObjectID, limit, page int64) ([]models.EventPostResponse, int64, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetPosts(ctx, &eventspb.GetPostsRequest{
			EventId: eventID.Hex(),
			Limit:   limit,
			Page:    page,
		})
	...
	resp := result.(*eventspb.GetPostsResponse)
...
func (c *Client) DeletePost(ctx context.Context, eventID, postID, userID primitive.ObjectID) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.DeletePost(ctx, &eventspb.DeletePostRequest{
			UserId:  userID.Hex(),
			EventId: eventID.Hex(),
			PostId:  postID.Hex(),
		})
...
func (c *Client) ReactToPost(ctx context.Context, postID, userID primitive.ObjectID, emoji string) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.ReactToPost(ctx, &eventspb.ReactToPostRequest{
			UserId:   userID.Hex(),
			PostId:   postID.Hex(),
			Reaction: emoji,
		})
...
func (c *Client) GetAttendees(ctx context.Context, eventID primitive.ObjectID, status models.RSVPStatus, limit, page int64) (*models.AttendeesListResponse, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetAttendees(ctx, &eventspb.GetAttendeesRequest{
			EventId: eventID.Hex(),
			Status:  string(status),
			Limit:   limit,
			Page:    page,
	...
	return toModelAttendeesResponse(result.(*eventspb.GetAttendeesResponse)), nil
}

func (c *Client) AddCoHost(ctx context.Context, eventID, userID, coHostID primitive.ObjectID) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.AddCoHost(ctx, &eventspb.CoHostRequest{
			UserId:       userID.Hex(),
			EventId:      eventID.Hex(),
...
func (c *Client) RemoveCoHost(ctx context.Context, eventID, userID, coHostID primitive.ObjectID) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.RemoveCoHost(ctx, &eventspb.CoHostRequest{
			UserId:       userID.Hex(),
			EventId:      eventID.Hex(),
			TargetUserId: coHostID.Hex(),
		})
...
func (c *Client) GetCategories(ctx context.Context) ([]models.EventCategory, error) {
	...
	return toModelCategories(result.(*eventspb.GetCategoriesResponse).GetCategories()), nil
}
...
func (c *Client) SearchEvents(ctx context.Context, req models.SearchEventsRequest, userID primitive.ObjectID) ([]models.EventResponse, int64, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.SearchEvents(ctx, toProtoSearchRequest(req, userID))
	})
	if err != nil {
		return nil, 0, err
	}
...
func (c *Client) ShareEvent(ctx context.Context, eventID primitive.ObjectID) error {
	_, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.ShareEvent(ctx, &eventspb.ShareEventRequest{
			EventId: eventID.Hex(),
		})
	})
	return err
...
func (c *Client) GetNearbyEvents(ctx context.Context, lat, lng, radiusKm float64, limit, page int64, userID primitive.ObjectID) ([]models.EventResponse, int64, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetNearbyEvents(ctx, &eventspb.NearbyEventsRequest{
			Latitude:  lat,
			Longitude: lng,
			RadiusKm:  radiusKm,
			Limit:     limit,
...
func (c *Client) GetRecommendations(ctx context.Context, userID primitive.ObjectID, limit int) ([]services.EventRecommendation, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetRecommendations(ctx, &eventspb.RecommendationRequest{
			UserId: userID.Hex(),
			Limit:  int32(limit),
		})
	})
	...
	return toModelRecommendations(result.(*eventspb.RecommendationResponse).GetRecommendations()), nil
}

func (c *Client) GetTrendingEvents(ctx context.Context, limit int) ([]services.TrendingScore, error) {
	result, err := c.cb.Execute(ctx, func() (interface{}, error) {
		return c.client.GetTrending(ctx, &eventspb.TrendingEventsRequest{
			Limit: int32(limit),
		})
	})
	if err != nil {
	...
	return toModelTrending(result.(*eventspb.TrendingEventsResponse).GetTrending()), nil
}
