...
type EventController struct {
	eventService          service.EventServiceContract
	recommendationService service.EventRecommendationServiceContract
}

func NewEventController(eventService service.EventServiceContract, recommendationService service.EventRecommendationServiceContract) *EventController {
